...
import * as s3asserts from "aws-cdk-lib/aws-s3-assets";
...
export class EBApplnStack extends cdk.Stack {
   constructor(scope: Construct, id: string, props?: EBEnvProps) {
    ...
    // zip app code file and send to S3

    const webAppZipArchive=new s3asserts.Asset(this, "WebAppZip", {
      path: `${__dirname}/../src`,
    })

    //create EB resources (app, environment, etc.)
